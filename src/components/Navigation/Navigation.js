...
const Navigation = (props) => {
  ...
  function renderSavedArticlesLink() {
    if (props.isLoggedIn) {
      return <NavLink to='/saved-news' exact={true} activeClassName="navbar__link_active_dark" className={`navbar__link ${props.navigationLinkColors('navbar__link_dark')}`}>Saved articles</NavLink>
    } else {
      return
    }
  }
